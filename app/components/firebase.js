            ...
            getStudentsCompletedHomework(student, month, year) {
                let soln = [];
                let date = year + "-" + month;
            ...
            getAllStudentsCompletedHomework: function (students, month, year) {
                let soln = [];
                let date = year + "-" + month;
            ...
            getAllStudentsLeaderboard(students, month, year) {
            ...
            /*** DONE ***/
            getStudentLeaderboardData(student, month, year) {
            ...
            getAllStudentsHomeworkPerMonth(students, year) {
                let soln = [];
            ...
            getStudentHomeworkPerMonth(student, year) {
            ...
            validateLogin(students, username, password) {
